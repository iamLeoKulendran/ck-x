document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateLabCategories() {
        ...
        examCategorySelect.innerHTML = '<option value="">Select certification type</option>';

        categories.forEach(category => {
            const option = document.createElement('option');
            option.value = category;
            option.textContent = getCategoryLabel(category);
            examCategorySelect.appendChild(option);
        });
        ...
        if (categories.includes('CKAD')) {
            ...
            examNameSelect.innerHTML = '<option value="">No labs available</option>';
            examNameSelect.disabled = true;
            examDescription.textContent = 'No labs available.';
    ...
    function filterLabsByCategory(category) {
        ...
        // Select the first lab in the category by default.
